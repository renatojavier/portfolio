define([], function(){
    ...
    return window.app.sortType.sortByMaleRightBlock = {
        o : {
            ...
            complete : function( param ){
                param = {
                    addon : function(){
                        ...
                        $('[data-dom-disp=addon-column]').children('span').eq(0).html(app.sortType.sortByMaleRightBlock.build.gender.male.length);
                        $('[data-dom-disp=addon-column]').children('span').eq(1).html(app.sortType.sortByMaleRightBlock.build.gender.female.length);
                    }
                };
